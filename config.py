...
getSurname = '⚠️WARNING⚠️\nЛаборатория 07: произошёл сбой!\n\nВнимание! В результате сбоя аппаратуры произошло...\n' \
             ...
             'идентификацию...\nВаша фамилия...'
welcomeMsg = 'Несколько дней назад известный ученый, твой наставник, изобрел машину времени, и первое ее ' \
             'тестирование решил провести на тебе. Однако произошел сбой аппаратуры, вследствие чего, в прошлом было' \
             ' создано большое количество твоих клонов, каждый из которых думает, что он настоящий. Вернуться в ' \
             'настоящее сможет только один, однако их одновременное существование разрушает пространственно-временной' \
             ' континуум, поэтому нужно уничтожить всех клонов любой ценой.'
getName = 'Имя...'
getGroup = 'Группа...'
getAvatar = 'Фото...'
...
rules = 'Правила игры:\n1) Насилие запрещено\n2) Устранять разрешено только используя спец.набор, выданный ' \
        'организаторами\n3) Любой клон (кроме жертвы) может прервать устранение, сказав «Ты ненастоящий», если ' \
        'человек выполняющий устранение держит в руках маркер\n4)Убивать можно на 1,2,5,6,7 этажах 2-го учебного ' \
        'корпуса. В лифтах убивать можно.'
